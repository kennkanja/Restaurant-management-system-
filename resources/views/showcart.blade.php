  ...
  @csrf
            @foreach($data as $data)
             <tr align="center">
                ...
                <td>
                <input type ="text" name="quality[]" value="{{$data->quality}}" hidden="">    
                {{$data->quality}}</td>
            ...
            <tr style="position: relative; top: -400px; right: -360px;">
            <td>
                <a href="{{url('/remove',$data2->id)}}" class="btn btn-warning"1>Remove</a>
            </td>
            </tr>
            @endforeach;
